// Venus.js
let scene, camera, renderer, VenusMesh;
...
function initVisualization() {
    ...
    const VenusTexture = textureLoader.load('VenusPlanetTexture.jpg'); // Replace with path to your texture
