// Jupiter.js
let scene, camera, renderer, JupiterMesh;
...
function initVisualization() {
    ...
    const JupiterTexture = textureLoader.load('JupiterTexture.jpg'); // Replace with path to your texture
