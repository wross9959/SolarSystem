// Neptune.js
let scene, camera, renderer, NeptuneMesh;
...
function initVisualization() {
    ...
    const NeptuneTexture = textureLoader.load('NeptuneTexture.jpg'); // Replace with path to your texture
    ...
    // Position the Neptune mesh
    NeptuneMesh.position.set(0, 0, 0);
